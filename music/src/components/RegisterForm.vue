<template>
  <div
    class="text-white text-center font-blod p-5 mb-4"
    v-if="reg_show_alert"
  ...
  <vee-form :validation-schema="schema" @submit="register" :initial-values="userData">
    ...
    <button
      ...
      :class="{ hidden: reg_in_submission }"
    >
      Submit
    </button>
  </vee-form>
  ...
  methods: {
    async register(values) {
      ...
      try {
        ...
        this.reg_alert_message = 'An unexpected error ocurred. Please try again later';
        console.log(error);
        return;
      }
